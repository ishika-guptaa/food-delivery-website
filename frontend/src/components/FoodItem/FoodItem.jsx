...
const FoodItem = ({ id, name, price, description, image }) => {
    ...
    // const [itemCount,setItemCount] = useState(0)//it is creating th estate variable for each prod which is not a good practice, so we will create cart item object in Storecontext
